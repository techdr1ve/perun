...
//TABLE STARTS BELOW
	...
	echo "<tr class='table_header'><th><h1 style='color:#111;font-size:22px;'><a href='https://en.wikipedia.org/wiki/United_States_Armed_Forces' target='_blank' rel='noopener noreferrer'>Military Branches</a></th><th><h1 style='color:#111;font-size:22px;'>Nation</th><th><h1 style='color:#111;font-size:22px;'><a href='http://www.akleg.gov/basis/get_documents.asp?session=29&docid=4362' target='_blank' rel='noopener noreferrer'>Medals</a></th><th><h1 style='color:#111;font-size:22px;'>Requirements</th></tr>"; // First Code							
