...
echo "<br><br><br><h3 style='margin:5px'>All Pilot Stats for *** DSMC_ *** CAMPAIGNS ONLY  <br><i>*Campaign naming errors are bc _0## Does Not Exist (DNE) yet* </i></h3>";
...
(SUBSTRING(f.`pe_DataMissionHashes_hash`, 1, CHAR_LENGTH(f.`pe_DataMissionHashes_hash`) - 26) LIKE '%DSMC%')  
 ...
 GROUP BY value_campaign, value_mission, a.`pe_LogEvent_airframe` 
 ORDER BY value_campaign, value_mission, a.`pe_LogEvent_airframe` 
...
//TABLE STARTS BELOW
	...
	echo "<tr class='table_header'><th style='text-align: center' colspan='7'>Aviator Record Summary</th><th style='text-align: center' colspan='6'>Life Events</th><th style='text-align: center' colspan='2'>PVP Events</th><th style='text-align: center' colspan='2'>A2A Kills</th><th style='text-align: center' colspan='10'>A2G Kills</th></tr>"; // First Code	
	echo "<tr class='table_header'><th>DSMC_ Campaign</th><th>Mission</th><th>Airframe</th><th>Branch</th><th>Flight Hours</th><th>A2A Kills</th><th>A2G Kills</th><th>Sorties</th><th>Landing%</th><th>Deaths</th><th>Ejections</th><th>Crashes</th><th>Bomb Self</th><th>PVP Kills</th><th>Team Kills</th><th>Planes</th><th>Helos</th><th>Tanks|APCs|LUVs</th><th>UnArmored</th><th>Air Defense</th><th>Artillery</th><th>TEL Missile</th><th>Infantry</th><th>Ships</th><th>Warehouses</th><th>Structures</th><th>Hits|Statics</th></tr>"; // First Code							
