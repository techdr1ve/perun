...
echo '<h3> Pilot Stats by Coalition: BLUE <img src="blue.png" alt="Paris" width="40" height="13"></h3>';
if ($result = $mysqli->query("SELECT DISTINCT a.`pe_LogEvent_pilotname`, a.`pe_LogEvent_friendly_fire_killer`, a.`pe_LogEvent_friendly_fire_killed`, a.`pe_LogEvent_coalition`,
...
COUNT(a.`pe_LogEvent_friendly_fire_killer`)*(-1) AS value_count_teamkillsneg,
...
//////////////////Pilot Stats - Coalition: BLUE
echo '<h3> Pilot Stats by Coalition: RED <img src="red.png" alt="Paris" width="40" height="13"></h3>';
if ($result = $mysqli->query("SELECT DISTINCT a.`pe_LogEvent_pilotname`, a.`pe_LogEvent_friendly_fire_killer`, a.`pe_LogEvent_friendly_fire_killed`, a.`pe_LogEvent_coalition`,
