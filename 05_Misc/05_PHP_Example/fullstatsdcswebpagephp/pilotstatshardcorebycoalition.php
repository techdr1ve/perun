...
echo '<h3> Realistic/Hardcore Pilot Stats by Coalition: BLUE <img src="blue.png" alt="Paris" width="40" height="13"></h3>';
...
CASE 
WHEN (a.`pe_LogEvent_datetime` = c.`pe_LastPilotDeath_datetime`) THEN (a.`pe_LogEvent_datetime`) 
...
/////////////FINAL///////All Pilot Statistics (Realistic/Hardcore) ... only populate stats after last pilot death for each pilot
echo '<h3> Realistic/Hardcore Pilot Stats by Coalition: RED <img src="red.png" alt="Paris" width="40" height="13"></h3>';
if ($result = $mysqli->query("SELECT DISTINCT a.`pe_LogEvent_pilotname`, a.`pe_LogEvent_friendly_fire_killer`, a.`pe_LogEvent_friendly_fire_killed`,
