...
WHERE a.pe_LogEvent_airframe NOT IN('N/A', 'artillery_commander', 'forward_observer', 'instructor', 'observer', '')

GROUP BY a.`pe_LogEvent_pilotid`, a.pe_LogEvent_airframe
ORDER BY a.pe_LogEvent_airframe ASC
