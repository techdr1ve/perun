...
echo "<h3 style='margin:5px'>Medal Awards & Honors: Requirements (<i>based upon your Hardcore Stats</i>)</h3>";
...
WHERE pe_medalsdb_nation = 'Russia'
...
//TABLE STARTS BELOW
	echo "<input type='text' id='myInput' onkeyup='myFunction()' placeholder='Filter by military branch...' title='Type in a name'>";	// searchable entry
	echo "<table class='table_stats' id='myTable' >";	
	echo "<tr class='table_header'><th><h1 style='color:#111;font-size:22px;'><a href='https://en.wikipedia.org/wiki/Russian_Armed_Forces' target='_blank' rel='noopener noreferrer'>Military Branches</a></th><th><h1 style='color:#111;font-size:22px;'>Nation</th><th><h1 style='color:#111;font-size:22px;'><a href='https://www.identifymedals.com/medals-database-medals-from-russia-ussr/' target='_blank' rel='noopener noreferrer'>Medals</a></th><th><h1 style='color:#111;font-size:22px;'>Requirements</th></tr>"; // First Code							
	while($row = mysqli_fetch_array($result))
	{
		echo "<tr class='header'>";
			
			//echo "<td style='text-align: center'>" . $row['pe_DataPlayers_lastname'] . " " . $row['DeathAncestory'] . "</td>";		
			echo "<td style='text-align: center'><h1 style='color:#111;font-size:17px;'>" . $row['pe_medalsdb_branch'] . "</h1></td>";
			echo "<td style='text-align: center'><h1 style='color:#111;font-size:17px;'>" . $row['pe_medalsdb_nation'] . "</h1></td>";			
			echo "<td style='text-align: center'><h1 style='color:#111;font-size:17px;'>" . $row['pe_medalsdb_award'] . "</h1></td>";
