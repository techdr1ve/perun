...
//			require "functions.drno.php";
			...
			// Make new tables in database needed for referencing; military branches by airframe, medals by country
			// require "install.php";
...
if ($result = $mysqli->query("SELECT DISTINCT a.`pe_LogEvent_pilotname`, a.`pe_LogEvent_coalition`, a.`pe_LogEvent_friendly_fire_killer`,
