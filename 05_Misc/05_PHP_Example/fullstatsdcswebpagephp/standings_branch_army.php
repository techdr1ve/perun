...
//Kill Stats Query (button is in 2nd query below)
				...
				WHERE a.`pe_LogEvent_militarybranch` = 'ARMY' AND b.pe_dataplayers_id=?	
...
echo '<br><br><br><h3 style="margin:5px">Overall Standings by Military Branch: Army <img src="green.png" alt="Paris" width="40" height="13"></h3>';
...
WHERE (a.`pe_LogEvent_militarybranch` = 'ARMY' AND a.`pe_LogEvent_militarybranch` NOT IN('','N/A')) AND NOT a.`pe_LogEvent_type` = 'change_slot'  AND (a.`pe_LogEvent_coalition` = 'RED' OR a.`pe_LogEvent_coalition` = '?' OR a.`pe_LogEvent_coalition` = 'BLUE') 
...
//TABLE STARTS BELOW
	...
	echo "<tr class='table_header'><th>Place</th><th>Pilot</th><th>Flight Hours [(+1/10min)*%]</th><th>A2A Kills (+4)</th><th>A2G Kills (Up)</th><th>Sorties</th><th>Landing%</th><th>Ejections (+1)</th><th>Crashes (-1)</th><th>Deaths (-3)</th><th>Bomb Self (-1)</th><th>PVP Kills (+5)</th><th>Team Kills (-10)</th><th>Total</th><th><a href='hardcorestats_rankreq_usa.php'>Rank [Army]</a></th><th><a href='hardcorestats_medalsreq_usa.php'>Medal Requirements</a></th></th></tr>"; // First Code							
	while($row = mysqli_fetch_array($result))
	{
		echo "<tr class='header'>";
...
/* 			if($row['rank_officer_usa_af']=="[2ndLt] Second Lieutenant (O-1)")
			...
			elseif($row['rank_officer_usa_ar']=="[MG] Major General (O-8)")
			{
			echo "<td style='text-align: center'>" . "<img src='./MG_t.png' height='60px' width='120px'/>" . "<br>Major<br>General<br>(O-8)" . "<br><br>" . str_repeat("<a href='https://en.wikipedia.org/wiki/Purple_Heart' target='_blank' rel='noopener noreferrer'><img src='./purpleheart.png' class='thumbnail3' height='40px' width='21px'/></a>", floor($row['medals_usa_ph'])) . "</td>";	
			}
			elseif($row['rank_officer_usa_ar']=="[LTG] Lieutenant General (O-9)")
			{
			echo "<td style='text-align: center'>" . "<img src='./LTG_t.png' height='60px' width='180px'/>" . "<br>Lieutenant<br>General<br>(O-9)" . "<br><br>" . str_repeat("<a href='https://en.wikipedia.org/wiki/Purple_Heart' target='_blank' rel='noopener noreferrer'><img src='./purpleheart.png' class='thumbnail3' height='40px' width='21px'/></a>", floor($row['medals_usa_ph'])) . "</td>";	
			...
			elseif($row['rank_officer_usa_ar']=="[GA] General of the Army (O-11)")
			{
			echo "<td style='text-align: center'>" . "<img src='./GA_t.png' height='60px' width='60px'/>" . "<br>General<br>of the<br>Army<br>(O-11)" . "<br><br>" . str_repeat("<a href='https://en.wikipedia.org/wiki/Purple_Heart' target='_blank' rel='noopener noreferrer'><img src='./purpleheart.png' class='thumbnail3' height='40px' width='21px'/></a>", floor($row['medals_usa_ph'])) . "</td>";	
			}			
			else
			{
			echo "<td style='text-align: center'>" . "<img src='./nothing.png' height='1px' width='1px'/>" . "</td>";	
