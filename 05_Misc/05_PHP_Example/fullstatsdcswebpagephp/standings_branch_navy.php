...
//Kill Stats Query (button is in 2nd query below)
				...
				WHERE a.`pe_LogEvent_militarybranch` = 'NAVY' AND b.pe_dataplayers_id=?	
...
echo '<br><br><br><h3 style="margin:5px">Overall Standings by Military Branch: Navy <img src="blue.png" alt="Paris" width="40" height="13"></h3>';
...
WHERE (a.`pe_LogEvent_militarybranch` = 'NAVY' AND a.`pe_LogEvent_militarybranch` NOT IN('','N/A'))
GROUP BY a.pe_LogEvent_pilotid
ORDER BY 
COUNT(a.`pe_LogEvent_kills_unarmed`)+
((COUNT(a.`pe_LogEvent_kills_infantry`)+COUNT(a.`pe_LogEvent_kills_artillery`))*2)+
...
/* 			if($row['rank_officer_usa_ar']=="[2LT] Second Lieutenant (O-1)")
			...
			if($row['rank_officer_usa_nv']=="[ENS] Ensign (O-1)")
			{
			echo "<td style='text-align: center'>" . "<img src='./2LT.png' height='60px' width='31px'/>" . "<br>" . "<img src='./ENS_t.png' class='thumbnail' height='40px' width='50px'/>" . "<br>Ensign<br>(O-1)" . "<br><br>" . str_repeat("<a href='https://en.wikipedia.org/wiki/Purple_Heart' target='_blank' rel='noopener noreferrer'><img src='./purpleheart.png' class='thumbnail3' height='40px' width='21px'/></a>", floor($row['medals_usa_ph'])) . "</td>";	
			}
			elseif($row['rank_officer_usa_nv']=="[LTJG] Lieutenant Junior Grade (O-2)")
			{
			echo "<td style='text-align: center'>" . "<img src='./1LT.png' height='60px' width='31px'/>" . "<br>" . "<img src='./LTJG_t.png' class='thumbnail' height='40px' width='50px'/>" . "<br>Lieutenant<br>Junior Grade<br>(O-2)" . "<br><br>" . str_repeat("<a href='https://en.wikipedia.org/wiki/Purple_Heart' target='_blank' rel='noopener noreferrer'><img src='./purpleheart.png' class='thumbnail3' height='40px' width='21px'/></a>", floor($row['medals_usa_ph'])) . "</td>";	
			}
			elseif($row['rank_officer_usa_nv']=="[Lt] Lieutenant (O-3)")
			{
			echo "<td style='text-align: center'>" . "<img src='./CPT_t.png' height='60px' width='60px'/>" . "<br>" . "<img src='./LT_t.png' class='thumbnail' height='40px' width='50px'/>" . "<br>Lieutenant<br>(O-3)" . "<br><br>" . str_repeat("<a href='https://en.wikipedia.org/wiki/Purple_Heart' target='_blank' rel='noopener noreferrer'><img src='./purpleheart.png' class='thumbnail3' height='40px' width='21px'/></a>", floor($row['medals_usa_ph'])) . "</td>";	
			}
			elseif($row['rank_officer_usa_nv']=="[LCDR] Lieutenant Commander (O-4)")
			{
			echo "<td style='text-align: center'>" . "<img src='./MAJ_t.png' height='60px' width='60px'/>" . "<br>" . "<img src='./LCDR_t.png' class='thumbnail' height='40px' width='50px'/>" . "<br>Lieutenant<br>Commander<br>(O-4)" . "<br><br>" . str_repeat("<a href='https://en.wikipedia.org/wiki/Purple_Heart' target='_blank' rel='noopener noreferrer'><img src='./purpleheart.png' class='thumbnail3' height='40px' width='21px'/></a>", floor($row['medals_usa_ph'])) . "</td>";	
			}
			elseif($row['rank_officer_usa_nv']=="[CDR] Commander (O-5)")
			{
			echo "<td style='text-align: center'>" . "<img src='./LTC_t.png' height='60px' width='60px'/>" . "<br>" . "<img src='./CDR_t.png' class='thumbnail' height='40px' width='50px'/>" . "<br>Commander<br>(O-5)" . "<br><br>" . str_repeat("<a href='https://en.wikipedia.org/wiki/Purple_Heart' target='_blank' rel='noopener noreferrer'><img src='./purpleheart.png' class='thumbnail3' height='40px' width='21px'/></a>", floor($row['medals_usa_ph'])) . "</td>";	
			}
			elseif($row['rank_officer_usa_nv']=="[Capt] Captain (O-6)")
			{
			echo "<td style='text-align: center'>" . "<img src='./COL_t.png' height='60px' width='90px'/>" . "<br>" . "<img src='./CAPT_t.png' class='thumbnail' height='40px' width='50px'/>" . "<br>Captain<br>(O-6)" . "<br><br>" . str_repeat("<a href='https://en.wikipedia.org/wiki/Purple_Heart' target='_blank' rel='noopener noreferrer'><img src='./purpleheart.png' class='thumbnail3' height='40px' width='21px'/></a>", floor($row['medals_usa_ph'])) . "</td>";	
			}
			elseif($row['rank_officer_usa_nv']=="[RDML] Rear Admiral Lower Half (O-7)")
			{
			echo "<td style='text-align: center'>" . "<img src='./BG_t.png' height='60px' width='60px'/>" . "<br>" . "<img src='./RDML_t.png' class='thumbnail' height='40px' width='50px'/>" . "<br>Rear Admiral<br>Lower Half<br>(O-7)" . "<br><br>" . str_repeat("<a href='https://en.wikipedia.org/wiki/Purple_Heart' target='_blank' rel='noopener noreferrer'><img src='./purpleheart.png' class='thumbnail3' height='40px' width='21px'/></a>", floor($row['medals_usa_ph'])) . "</td>";	
			}
			elseif($row['rank_officer_usa_nv']=="[RADM] Rear Admiral Upper Half (O-8)")
			{
			echo "<td style='text-align: center'>" . "<img src='./MG_t.png' height='60px' width='120px'/>" . "<br>" . "<img src='./RADM_t.png' class='thumbnail' height='40px' width='50px'/>" . "<br>Rear Admiral<br>Upper Half<br>(O-8)" . "<br><br>" . str_repeat("<a href='https://en.wikipedia.org/wiki/Purple_Heart' target='_blank' rel='noopener noreferrer'><img src='./purpleheart.png' class='thumbnail3' height='40px' width='21px'/></a>", floor($row['medals_usa_ph'])) . "</td>";	
			}
			elseif($row['rank_officer_usa_nv']=="[VADM] Vice Admiral (O-9)")
			{
			echo "<td style='text-align: center'>" . "<img src='./LTG_t.png' height='60px' width='180px'/>" . "<br>" . "<img src='./VADM_t.png' class='thumbnail' height='40px' width='50px'/>" . "<br>Vice Admiral<br>(O-9)" . "<br><br>" . str_repeat("<a href='https://en.wikipedia.org/wiki/Purple_Heart' target='_blank' rel='noopener noreferrer'><img src='./purpleheart.png' class='thumbnail3' height='40px' width='21px'/></a>", floor($row['medals_usa_ph'])) . "</td>";	
			}
			elseif($row['rank_officer_usa_nv']=="[ADM] Admiral (O-10)")
			{
			echo "<td style='text-align: center'>" . "<img src='./GEN_t.png' height='60px' width='240px'/>" . "<br>" . "<img src='./ADM_t.png' class='thumbnail' height='40px' width='50px'/>" . "<br>Admiral<br>(O-10)" . "<br><br>" . str_repeat("<a href='https://en.wikipedia.org/wiki/Purple_Heart' target='_blank' rel='noopener noreferrer'><img src='./purpleheart.png' class='thumbnail3' height='40px' width='21px'/></a>", floor($row['medals_usa_ph'])) . "</td>";	
			}
			elseif($row['rank_officer_usa_nv']=="[FADM] Fleet Admiral (O-11)")
			{
			echo "<td style='text-align: center'>" . "<img src='./GA_t.png' height='60px' width='60px'/>" . "<br>" . "<img src='./FADM_t.png' class='thumbnail' height='40px' width='50px'/>" . "<br>Fleet Admiral<br>(O-11)" . "<br><br>" . str_repeat("<a href='https://en.wikipedia.org/wiki/Purple_Heart' target='_blank' rel='noopener noreferrer'><img src='./purpleheart.png' class='thumbnail3' height='40px' width='21px'/></a>", floor($row['medals_usa_ph'])) . "</td>";	
			}			
			else
			{
			echo "<td style='text-align: center'>" . "<img src='./nothing.png' height='1px' width='1px'/>" . "</td>";	
