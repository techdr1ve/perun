...
$sql="
		...
		g.pe_teams_name,
		b.`pe_LogEvent_teamname`AS value_teamname,		
		...
		INNER JOIN pe_teams AS g
		ON b.`pe_LogEvent_teamname` = g.`pe_teams_name`
		
		WHERE g.`pe_teams_name` = '".$y."'
