...
//Kill Stats Query (button is in 2nd query below)
				...
				WHERE (a.`pe_LogEvent_coalition` = 'BLUE' OR a.`pe_LogEvent_coalition` = '?') AND NOT a.`pe_LogEvent_type` = 'change_slot' AND b.pe_dataplayers_id=?	
...
echo '<br><br><br><h3 style="margin:5px"> Standings by Coalition: BLUE <img src="blue.png" alt="Paris" width="40" height="13"></h3>';
