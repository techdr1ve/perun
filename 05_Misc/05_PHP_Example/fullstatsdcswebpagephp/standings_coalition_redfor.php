...
//Kill Stats Query (button is in 2nd query below)
				...
				WHERE (a.`pe_LogEvent_coalition` = 'RED' OR a.`pe_LogEvent_coalition` = '?') AND NOT a.`pe_LogEvent_type` = 'change_slot' AND b.pe_dataplayers_id=?			
...
echo '<br><br><br><h3 style="margin:5px"> Standings by Coalition: RED <img src="red.png" alt="Paris" width="40" height="13"></h3>';
...
WHERE (a.`pe_LogEvent_coalition` = 'RED' OR a.`pe_LogEvent_coalition` = '?') AND NOT a.`pe_LogEvent_type` = 'change_slot' 
GROUP BY a.pe_LogEvent_pilotid
ORDER BY 
			COUNT(a.`pe_LogEvent_kills_unarmed`)+
			((COUNT(a.`pe_LogEvent_kills_infantry`)+COUNT(a.`pe_LogEvent_kills_artillery`))*2)+
