...
if ($result = $mysqli->query("SELECT DISTINCT a.`pe_LogEvent_pilotname`, a.`pe_LogEvent_friendly_fire_killer`,
...
COUNT('value_mission') AS value_mission_count,
...
//TABLE STARTS BELOW
	...
	echo "<tr class='table_header'><th style='text-align: center' colspan='3'>Mission Summary</th><th style='text-align: center' colspan='5'>Life Events</th><th style='text-align: center' colspan='2'>PVP Events</th><th style='text-align: center' colspan='2'>A2A Kills</th><th style='text-align: center' colspan='10'>A2G Kills</th></tr>"; // First Code	
	echo "<tr class='table_header'><th>Mission</th><th>A2A Kills</th><th>A2G Kills</th><th>Sorties</th><th>Landing%</th><th>Deaths</th><th>Ejections</th><th>Crashes</th><th>PVP Kills</th><th>Team Kills</th><th>Planes</th><th>Helos</th><th>Tanks|APCs|LUVs</th><th>UnArmored</th><th>Air Defense</th><th>Artillery</th><th>TEL Missile</th><th>Infantry</th><th>Ships</th><th>Warehouses</th><th>Structures</th><th>Hits|Aesthetic Statics</th></tr>"; // First Code					
...
/* echo "<h3>MISSION Statistics WITH KEY --> _  as Last character in .miz file; ex: 'Bombastic$.miz' ... The mission will show as 'Bombastic.miz' </h3>";
